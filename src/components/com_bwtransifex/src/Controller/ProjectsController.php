 ...
 *
 * BwTransifex projects controller class for the component frontend
 *
...
/**
 * BwTransifex Projects Controller
 *
 * @package BwTransifex
 *
 * @since 1.0.0
...
class ProjectsController extends AdminController
{
     ...
     * @since 1.0.0
     */
    public function getModel($name = 'Projects', $prefix = 'Site', $config = array('ignore_request' => true)): BaseDatabaseModel
{
